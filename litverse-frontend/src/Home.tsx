...
import { Book, Home as HomeIcon, Compass, User, Info, ThumbsUp, MessageCircle, Share2 } from 'lucide-react';
...
const samplePosts: Post[] = [
  {
    ...
    content: "This book completely changed my perspective on life choices and parallel universes...",
    author: "bookworm42",
    upvotes: 1234,
    comments: 89,
  ...
  },
  {
    ...
    content: "Let's discuss Andy Weir's latest sci-fi masterpiece! What did you think about...",
    author: "scifi_lover",
    upvotes: 856,
    comments: 156
  }
          ...
          {samplePosts.map(post => (
            <article key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                {post.image && (
                  <img src={post.image} alt="Post" className="w-full h-64 object-cover mb-4 rounded-lg" />
                )}
